...
namespace BotApp.Service.Api.Astronomy.Moon
{
    ...
    {
        public static Task GetMoonPhase(decimal latitude, decimal longtitude, DateTime dateTime)
        {
            /*
        ...
        public static Task GetMoonPhase(decimal latitude, decimal longtitude, DateTime startDateTime, DateTime endDateTime)
        {
            /*
            var service = new AstronomyService(AuthorizeTokensConsts.TDAccessKey, AuthorizeTokensConsts.TDSecretKey);
